...
const fetchData = async () => {
    try {
        ...
        pokemons.slice(offset, offset + limit).forEach((entry, index) => {
            ...
            card.innerHTML = `
                <div class="card">
                    <img class="card-img-top" src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemonId}.png">
                    <div class="card-body">
